...
public class RegisterTest extends BaseTest {
    ...
    public void userShouldRegisterAccountSuccessfully() {
        ...
        driver.findElement(By.id("FirstName")).sendKeys("Stain");
        ...
        driver.findElement(By.name("Email")).sendKeys("steve456@gmail.com");
        driver.findElement(By.id("Password")).sendKeys("steve321");
